-- Migration: 20260226171052_dashboard_rpc_text_type_fix
-- Purpose: Overrides the RPC parameter from UUID to TEXT to prevent JSON payload casting failures in the JS client
